...
const StorageGatePassCreateForm = memo(function StorageGatePassCreateForm() {
  ...
  return (
    <main className="font-custom mx-auto max-w-2xl px-4 py-6 sm:px-8 sm:py-12">
      ...
      <StorageSummarySheet
        ...
        submitLabel="Create Storage Gate Pass"
...
function RouteComponent() {
  return <StorageGatePassCreateForm />;
}
